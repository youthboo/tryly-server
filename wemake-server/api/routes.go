...
func SetupRoutes(db *sqlx.DB, cfg *config.Config) *fiber.App {
	...
	rfqs.Post("/:rfq_id/quotations", h.quotation.CreateQuotation)
	...
	quotations.Post("/", h.quotation.CreateDetailed)
	quotations.Get("/", h.quotation.ListCollection)
	quotations.Get("/me", h.quotation.ListMine)
	quotations.Get("/:quotation_id/history", h.quotation.ListHistory)
	quotations.Get("/:quotation_id", h.quotation.GetQuotation)
	quotations.Post("/:quotation_id/revision", h.quotation.CreateRevision)
	quotations.Post("/:quotation_id/accept", h.quotation.Accept)
	quotations.Post("/:quotation_id/reject", h.quotation.Reject)
	quotations.Patch("/:quotation_id", h.quotation.PatchQuotation)
